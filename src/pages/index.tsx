...
const Home: NextPage = () => {
  return (
    <MainLayout pageName='Home'>
      <div className='relative h-screen lg:h-screen flex flex-col w-full items-center justify-center text-gray-600'>
        <p className='text-4xl font-bold'>Ivan Campos Wainer</p>
        <p className='text-xl font-semibold text-gray-400'><span className='text-emerald-400'>Frontend</span> Web Developer</p>
