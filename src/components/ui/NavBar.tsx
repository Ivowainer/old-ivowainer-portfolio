...
const NavBar: React.FC<NavBarProps> = ({ pageName }) => {
    return (
        <div className="flex lg:w-auto lg:dark:bg-gray-700 dark:bg-gray-600 lg:flex-col justify-between items-center px-6 py-8 gap-12 lg:gap-20 h-full text-gray-500">
            <p className="font-bold text-3xl text-emerald-500">ICW</p>
