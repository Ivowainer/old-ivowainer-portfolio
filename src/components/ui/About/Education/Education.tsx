  ...
  return (
    <section className=" lg:px-10 pt-10 mt-24" id="education">
        ...
        <div className="flex flex-col px-10 lg:w-7/12 lg:pl-20 mt-10" >
            <BookMark text="Coderhouse - Programacion Backend" date="Cursando en 2022" description="Desarrollo de aplicaciones modernas con NodeJS, MongoDB y técnicas asincrónicas; Trabajo sobre bases de datos SQL y NoSQL, dominando la gestión de los datos en forma eficiente, ágil y con una gran facilidad de escalabilidad." height="h-36"/>
            <BookMark text="Lic. Ciencias de la Computación" date="Cursando en 2022" description="Licenciatura en Ciencias de la Computación en la FCEIA (Ciencias Exactas, Ingeniería y Agrimensura), UNR (Universidad Nacional de Rosario) "/>
            <BookMark text="Curso NextJS" date="Cursando en 2022" description="Next.js: El framework de React para producción | del profesor Fernando Herrera en Udemy" height="h-32 lg:h-24" />
