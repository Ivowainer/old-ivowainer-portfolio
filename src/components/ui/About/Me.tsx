    ...
    return (
        <div className="flex flex-col lg:grid lg:grid-cols-3 text-gray-400 mt-10 text-lg gap-5 items-center justify-items-start">
            ...
            <p className="col-start-1 col-end-4">
                I also have hobbies, being play the guitar, the piano (my favorite instrument), I like to go out with friends and skateboard. I also do strength training at the gym almost daily. I
                love both sunny and rainy days because I can make the most of them.
            </p>
        </div>
    );
};
